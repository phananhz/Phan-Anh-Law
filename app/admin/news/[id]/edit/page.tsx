...
export default async function EditNewsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const initialArticle = databaseArticle
    ? {
        ...
        category: databaseArticle.category || 'Hoạt động',
        status: databaseArticle.status === 'published' ? 'published' as const : 'draft' as const,
        body: databaseArticle.body_json,
        coverImagePath: databaseArticle.cover_image_path || '',
        coverImageUrl,
        coverImageAlt: databaseArticle.cover_image_alt || '',
        persisted: true,
      }
    : {
        ...
        body: fallbackArticle!.body || fallbackArticle!.content,
        coverImagePath: '',
        coverImageUrl: fallbackArticle!.coverImageUrl,
        coverImageAlt: fallbackArticle!.coverImageAlt,
        persisted: false,
      };
